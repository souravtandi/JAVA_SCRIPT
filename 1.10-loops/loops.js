...
console.log("******itrate over array using forEach loop******")
names.forEach(function test(n){
    console.log(n);
});

//iterate over array using for of loop
console.log("******itrate over array using for of loop******")
for(n of names){
console.log(n);
}
...
//while loop in JS
//1.0 initialization, 2. Condition checking , 3. Body execuation, 4. Updation
